" Vim colorscheme
" Author: Camilo Torres (https://github.com/camilotorresf/vim-colors-yellownote)
" Maintainer: Camilo Torres
" Notes: Based on alabaster theme by Alexander Gudulin https://github.com/agudulin/vim-colors-alabaster, in turn based on Alabaster BG theme by Nikita Prokopov https://github.com/tonsky/sublime-scheme-alabaster/
...
" Editor settings
" --------------------------------
exe "hi! Normal"          "ctermfg=".s:black "ctermbg=".s:yellow "cterm=".s:none
...
" Spelling
" --------------------------------
exe "hi! SpellBad"        "ctermfg=".s:none  "ctermbg=".s:white  "cterm=".s:none
